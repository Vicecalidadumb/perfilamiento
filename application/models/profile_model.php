...
class Profile_model extends CI_Model {
    ...
    public function get_table() {
        $this->db->select('cargue_usuarios');
        $this->db->like('cargue_usuarios.USUARIO_NOMBRES', $this->input->post('sSearch'));
        $this->db->where('cargue_usuarios.USUARIO_APELLIDOS', $this->input->post('field2'));
        $this->db->limit(
